...
class StoredProcedureExecutorTest {
    ...
    @Test
    @DisplayName("Should propagate SQL errors raised by the mapper")
    void shouldPropagateSqlErrors() throws SQLException {
        ResultSet resultSet = mock(ResultSet.class);
    ...
    @Test
    @DisplayName("Should drain and close result sets when discarding output")
    void shouldDrainResultSetsWhenDiscardingOutput() throws SQLException {
        ResultSet resultSet = mock(ResultSet.class);
