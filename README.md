...
--changeset j36147:sp_Gen_Xml_Siniestros_CoaseguroC_pantalla stripComments:false dbms:mssql
USE [SiniestrosWp]
...
GO
CREATE OR ALTER procedure  [dbo].[sp_Gen_Xml_Siniestros_CoaseguroC](@FC nvarchar(6)) as 
/*
