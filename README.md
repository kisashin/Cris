...
import { MatDialog, MatDialogModule } from '@angular/material/dialog'; // NUEVO
import { MatIconModule } from '@angular/material/icon';
import { MatTableModule } from '@angular/material/table';
import { ToastrService } from 'ngx-toastr';

import { AccountingClosingCaService } from '../../services/accounting-closing-ca.service';
import { ConfirmDialogComponent } from '../../components/confirm-dialog/confirm-dialog.component'; // NUEVO
...
export class AccountingClosingCAComponent implements OnInit {
  ...
  constructor(
    ...
    private readonly dialog: MatDialog, // NUEVO
  ...
  // NUEVO: abre el diálogo y solo ejecuta si el usuario confirma
  /**
  ...
  // NUEVO: antes era el cuerpo de generateAccountingEntries
