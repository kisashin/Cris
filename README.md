...
--changeset j36147:COIMPLUT-35258_sp_contabiliza_cardifCentro_20260826_01 splitStatements:false

CREATE OR ALTER PROCEDURE [dbo].[sp_contabiliza_cardifCentro](@r int=null) AS
Declare
@fecha varchar(12),
@periodo varchar(12),
@periodo2 int;
