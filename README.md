...
class CardifPeruClosingServiceImplTest {
    ...
    @Mock
    private CardifPeruAccountingProcedureRepository procedureRepository;
    ...
    class GenerateAccountingEntries {
        ...
        void shouldExecuteProcedureWhenPendingExist() {
            ...
            verify(procedureRepository).executeAccountingProcedure(anyInt());
        }
        ...
        void shouldNotExecuteProcedureWhenNoPending() {
            ...
            verify(repository).countPendingMovements();
            verifyNoInteractions(procedureRepository);
        }
        ...
        void shouldThrowWhenProcedureFails() {
            ...
            org.mockito.Mockito.doThrow(
                    ...
                    .when(procedureRepository).executeAccountingProcedure(anyInt());
