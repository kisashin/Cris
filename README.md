CardifPeruClosingExcelHelperTest
 ...
 */
class CardifPeruClosingExcelHelperTest {

    private static final File POI_TEMP_DIR =
            new File("target/poi-files");

    private final CardifPeruClosingExcelHelper helper =
            new CardifPeruClosingExcelHelper();
    ...
    void shouldGenerateValidExcelWithData() throws IOException {
        ...
        CardifPeruClosing secondMovement = CardifPeruClosing.builder()
                .idCarvajal(273767966873L)
                .partner("FINANCIERA TEST 2")
                .claimNumber("0772025A003455")
                .movementValue(14000.0)
                .currency("PEN")
                .build();
