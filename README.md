...
import { CardifPeruClosingService } from './cardif-peru-closing.service';
import { INewGeneralResponse } from '../models/new-general-response.interface';

describe('CardifPeruClosingService', () => {
  let service: CardifPeruClosingService;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [CardifPeruClosingService]
    });

    service = TestBed.inject(CardifPeruClosingService);
  ...
  describe('#downloadMovementsReport', () => {
    it('should GET the Excel report as Blob', () => {
      ...
      service.downloadMovementsReport().subscribe(response => {
        ...
        ).toContain('ReporteMovimientosCardifPeru.xlsx');
      });
