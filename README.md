...
--changeset j36147:COIMPLUT-35258_sp_Gen_Xml_Siniestros_ReasegCentro_20260826_01 splitStatements:false
...
BEGIN
	...
	into  #xmlSinCen
	from #SinCCen m
	inner join cardifwp.[dbo].[CUENTAS_CONTABLES_PROD] c  on c.GRUPO = 'RC'
