...
--changeset j36147:sp_Gen_Xml_Siniestros_ReasegAlfa_pantalla stripComments:false dbms:mssql
USE [SiniestrosWp]
...
GO
CREATE OR ALTER procedure  [dbo].[sp_Gen_Xml_Siniestros_ReasegAlfa](@FC nvarchar(6)) as 
/*
