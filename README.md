...
--changeset j36147:HU_Reaseguro_566_sp_CargaSiniestrosAlfa_20260903_01 stripComments:false dbms:mssql
...
CREATE OR ALTER PROCEDURE [dbo].[sp_CargaSiniestrosAlfa] (@Producto int=null, @Archivo nvarchar(200)=null)
AS
BEGIN
